...
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py auth password
```
...
```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py auth token \
  --token "$WEWORK_TOKEN"
```
...
```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py auth status
```

List locations in a city:

```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py locations \
  --city "Singapore"
```
...
```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py availability \
  --date 2026-05-26 \
  --city "Singapore" \
  --name "21 Collyer"
```
...
```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py bookings
```

Preview a cancellation by booking ID:

```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py cancel \
...
```bash
python3 /Users/bugenzhao/.codex/skills/wework/scripts/wework_min.py book \
  --date 2026-05-26 \
  --city "Singapore" \
  --name "WeWork" \
  --dry-run
